...
@section('page-styles')
    ...
    <link rel="stylesheet" href="{{ URL::asset('vendor/bootstrap-colorpicker/css/bootstrap-colorpicker.css') }}"/>
    <link rel="stylesheet" href="{{ URL::asset('vendor/bootstrap-timepicker/css/bootstrap-timepicker.css') }}"/>
    <link rel="stylesheet" href="{{ URL::asset('vendor/dropzone/css/basic.css') }}"/>
    <link rel="stylesheet" href="{{ URL::asset('vendor/dropzone/css/dropzone.css') }}"/>
    <link rel="stylesheet" href="{{ URL::asset('vendor/bootstrap-markdown/css/bootstrap-markdown.min.css') }}"/>
    <link rel="stylesheet" href="{{ URL::asset('vendor/summernote/summernote.css') }}"/>
    <link rel="stylesheet" href="{{ URL::asset('vendor/summernote/summernote-bs3.css') }}"/>
    <link rel="stylesheet" href="{{ URL::asset('vendor/codemirror/lib/codemirror.css') }}"/>
    <link rel="stylesheet" href="{{ URL::asset('vendor/codemirror/theme/monokai.css') }}"/>
@endsection
@section('content')
...
<script src="{{ URL::asset('vendor/bootstrap-multiselect/bootstrap-multiselect.js') }}"></script>
<script src="{{ URL::asset('vendor/jquery-maskedinput/jquery.maskedinput.js') }}"></script>
<script src="{{ URL::asset('vendor/bootstrap-tagsinput/bootstrap-tagsinput.js') }}"></script>
<script src="{{ URL::asset('vendor/bootstrap-colorpicker/js/bootstrap-colorpicker.js') }}"></script>
<script src="{{ URL::asset('vendor/bootstrap-timepicker/js/bootstrap-timepicker.js') }}"></script>
<script src="{{ URL::asset('vendor/fuelux/js/spinner.js') }}"></script>
<script src="{{ URL::asset('vendor/dropzone/dropzone.js') }}"></script>
<script src="{{ URL::asset('vendor/bootstrap-markdown/js/markdown.js') }}"></script>
<script src="{{ URL::asset('vendor/bootstrap-markdown/js/to-markdown.js') }}"></script>
<script src="{{ URL::asset('vendor/bootstrap-markdown/js/bootstrap-markdown.js') }}"></script>
<script src="{{ URL::asset('vendor/codemirror/lib/codemirror.js') }}"></script>
<script src="{{ URL::asset('vendor/codemirror/addon/selection/active-line.js') }}"></script>
<script src="{{ URL::asset('vendor/codemirror/addon/edit/matchbrackets.js') }}"></script>
<script src="{{ URL::asset('vendor/codemirror/mode/javascript/javascript.js') }}"></script>
<script src="{{ URL::asset('vendor/codemirror/mode/xml/xml.js') }}"></script>
<script src="{{ URL::asset('vendor/codemirror/mode/htmlmixed/htmlmixed.js') }}"></script>
<script src="{{ URL::asset('vendor/codemirror/mode/css/css.js') }}"></script>
<script src="{{ URL::asset('vendor/summernote/summernote.js') }}"></script>
<script src="{{ URL::asset('vendor/bootstrap-maxlength/bootstrap-maxlength.js') }}"></script>
