...
@section('page-script-2')
    <script src="{{ URL::asset('/javascripts/tables/examples.datatables.default.js') }}"></script>
    <script src="{{ URL::asset('/javascripts/tables/examples.datatables.row.with.details.js') }}"></script>
    <script src="{{ URL::asset('/javascripts/tables/examples.datatables.tabletools.js') }}"></script>
@endsection
